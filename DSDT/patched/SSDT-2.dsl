 ...
 *
 * Disassembly of SSDT-2.aml, Mon Apr  2 11:12:02 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00005B3E (23358)
 *     Revision         0x02
 *     Checksum         0x78
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (CLPG, 0, NotSerialized)
        {
            ...
            While (One)
            {
                ...
                Or (ShiftLeft (WMSB, 0x08), WLSB, POFF)
                Increment (INDX)

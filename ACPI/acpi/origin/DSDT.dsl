 ...
 *
 * Disassembly of DSDT.aml, Fri Nov  2 13:34:27 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FE6B (65131)
 *     Revision         0x02
 *     Checksum         0x0C
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (EHC1)
        {
            ...
            Method (_DSW, 3, NotSerialized)  // _DSW: Device Sleep Wake
            {
                ...
                Store (One, ^^LPCB.EC0.USBW) /* \_SB_.PCI0.LPCB.EC0_.USBW */
            }
            ...
            Method (_Q61, 0, NotSerialized)  // _Qxx: EC Query
            {
                If (LEqual (GATY, 0x02))
                {
                    ...
                    If (LNotEqual (DGST, 0xD4))
                    {
                        ...
                        Store (0xD4, DGST) /* \_SB_.PCI0.LPCB.EC0_.DGST */
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (LEqual (DBGS, Zero))
        {
            Store (Zero, RT10) /* \RT10 */
            Store (0x20, PME1) /* \PME1 */
            Store (One, PME0) /* \PME0 */
            Store (0x20, PMS1) /* \PMS1 */
            Store (One, PMS0) /* \PMS0 */
        }
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            If (LEqual (ECON, One))
            {
                If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
                {
                    Store (\_SB.PCI0.LPCB.EC0.LSTE, LIDS) /* External reference */
                    If (IGDS)
                    {
                        If (LEqual (LIDS, Zero))
                        {
        ...
        Method (_OSC, 4, Serialized)  // _OSC: Operating System Capabilities
        {
            ...
            If (LEqual (Arg0, ToUUID ("0811b06e-4a27-44f9-8d60-3cbbc22e7b48") /* Platform-wide Capabilities */))
            {
                If (LEqual (Arg1, One))
                {
                    ...
                    If (LOr (_OSI ("Windows 2013"), _OSI ("Windows 2015")))
                    {

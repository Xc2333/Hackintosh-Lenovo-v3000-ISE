 ...
 *
 * Disassembly of SSDT-3-CB-01.aml, Fri Nov  2 13:34:27 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000342F (13359)
 *     Revision         0x02
 *     Checksum         0xF4
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
            ...
            Method (TSDD, 0, Serialized)
            {
                Switch (BID)
                {
...
)
                    {
                        ...
                        {
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR1)), 0x0A), 0x0AAC), Index (TULT, 
                                0x05))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR2)), 0x0A), 0x0AAC), Index (TULT, 
                                0x06))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR3)), 0x0A), 0x0AAC), Index (TULT, 
                                0x07))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR4)), 0x0A), 0x0AAC), Index (TULT, 
                                0x08))
                            If (CondRefOf (\_SB.PCI0.LPCB.H_EC.TSR5))
                            {
                                Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR5)), 0x0A), 0x0AAC), Index (TULT, 
                                    0x09))
                            }

                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), 0x0A), 0x0AAC), Index (TULT, 
                                0x0A))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7)), 0x0A), 0x0AAC), Index (TULT, 
                                0x0B))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMAX)), 0x0A), 0x0AAC), Index (TULT, 
                                0x0C))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)), 0x0A), 0x0AAC), Index (TULT, 
                                0x0D))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)), 0x0A), 0x0AAC), Index (TULT, 
                                0x0E))
                        }
                    ...
                    Default
                    {
                        ...
                        If (LEqual (\_SB.PCI0.LPCB.H_EC.ECAV, One))
                        {
                            ...
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x0A))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x0B))
                            ...
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x0E))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x0F))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD0)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x10))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD1)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x11))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD2)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x12))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD3)), 0x0A), 0x0AAC), Index (TMPV, 
                                0x13))
                        }
                ...
                If (LEqual (\_SB.PCI0.LPCB.H_EC.ECAV, One))
                {
                    Switch (BID)
                    {
                        Case (0x30)
                        {
                            ...
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PENV)), Index (OSD3, Zero))
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.CFSP)), Index (OSD3, One))
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.CFS2)), Index (OSD3, 0x02))
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR3)), Index (OSD3, 0x03))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER1)), 0x02), Index (OSD3, 0x04))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER2)), 0x02), Index (OSD3, 0x05))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER3)), 0x02), Index (OSD3, 0x06))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER4)), 0x02), Index (OSD3, 0x07))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER5)), 0x02), Index (OSD3, 0x08))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER6)), 0x02), Index (OSD3, 0x09))
                        ...
                        Case (0x31)
                        {
                            ...
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER6)), 0x02), Index (OSD2, 0x08))
                        ...
                        Case (0x38)
                        {
                            ...
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR3)), Index (OSD4, Zero))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER3)), 0x02), Index (OSD4, One))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER4)), 0x02), Index (OSD4, 0x02))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER5)), 0x02), Index (OSD4, 0x03))
                            Store (ShiftLeft (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TER6)), 0x02), Index (OSD4, 0x04))
